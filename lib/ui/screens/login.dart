...
import 'package:recipes_app/ui/masked_text.dart';
import 'package:recipes_app/utils/logger.dart';

import '../ReactiveRefreshIndicator.dart';
...
class LoginScreenState extends State<LoginScreen> {
  ...
  verificationFailed(AuthException authException) {
    ...
    Logger.log(TAG,
        message:
            "onVerification failed,code: ${authException.code},message: ${authException.message} ");
  }

  // PhoneCode Sent
  codeSent(String verificationId, [int forceResendingToken]) async {
    Logger.log(TAG,
        message: "Verification code sent to ${_phoneNumberController.text}");
  ...
  codeAutoRetreivalTimeout(String verificationId) {
  ...
  String get phoneNumber {
    try {
      ...
      if (unmaskedText != null) _phoneNumber = "+254$unmaskedText".trim();
    } catch (error) {
      Logger.log(TAG,
